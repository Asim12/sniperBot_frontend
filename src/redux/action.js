...
export const login = createAsyncThunk(
  ...
  async ({ email, password, router }, { dispatch }) => {
    try {
      ...
      console.log('zain');
      console.log('Backend URL:', '34.204.94.231:3000');

      const response = await axios.post('http://34.204.94.231:3000/api/login', {
        // Your login payload
        email,
        password,
      });
...
export const registerUser = createAsyncThunk(
  ...
  async ({ firstName, lastName, email, password, router }, { dispatch }) => {
    try {
      const response = await axios.post('http://34.204.94.231:3000/api/register', {
  ...
  async (password, { dispatch }) => {
    try {
      ...
      const response = await axios.post(
        'http://34.204.94.231:3000/api/getWalletDetails',
        { password },
        {
          headers: {
...
export const getSoldOrders = createAsyncThunk(
  ...
  async ({ limit, pageNumber }, { dispatch, rejectWithValue }) => {
    try {
      ...
      const token = localStorage.getItem('token');
      const response = await axios.post(
        'http://34.204.94.231:3000/api/getSoldOrder',
...
export const getNewOrders = createAsyncThunk(
  ...
  async ({ limit, pageNumber }, { dispatch, rejectWithValue }) => {
    try {
      ...
      const token = localStorage.getItem('token');
      const response = await axios.post(
        'http://34.204.94.231:3000/api/getNewOrders',
        { limit, page_number: pageNumber },
        {
          headers: {
            'x-access-token': `${token}`,
...
export const sellOrders = createAsyncThunk(
  ...
  async ({ order_id }, { dispatch, rejectWithValue }) => {
    try {
      ...
      const token = localStorage.getItem('token');
      const response = await axios.post(
        'http://34.204.94.231:3000/api/soldManual',
        { order_id },
        {
          headers: {
            'x-access-token': `${token}`,
...
export const getBuyOrders = createAsyncThunk(
  ...
  async ({ limit, pageNumber }, { dispatch, rejectWithValue }) => {
    try {
      ...
      const token = localStorage.getItem('token');
      const response = await axios.post(
        'http://34.204.94.231:3000/api/getBuyOrder',
        { limit, page_number: pageNumber },
        {
          headers: {
            'x-access-token': `${token}`,
...
export const getCustomOrders = createAsyncThunk(
  ...
  async ({ limit, pageNumber }, { dispatch, rejectWithValue }) => {
    try {
      ...
      const token = localStorage.getItem('token');
      const response = await axios.post(
        'http://34.204.94.231:3000/api/getCustomOrder',
        { limit, page_number: pageNumber },
        {
          headers: {
            'x-access-token': `${token}`,
...
export const addCustomOrders = createAsyncThunk(
  ...
  async ({ contract_address }, { dispatch, rejectWithValue }) => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.post(
        'http://34.204.94.231:3000/api/addCustomContracts',
        { contract_address },
        {
          headers: {
            'x-access-token': `${token}`,
...
export const getNotifications = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      ...
      const response = await axios.get('http://34.204.94.231:3000/api/getNotifications', {
        headers: {
          'x-access-token': token,
        },
      });
...
export const markAllasReadNotifications = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      const token = localStorage.getItem('token'); // Assuming your user slice has a 'token' field
      const response = await axios.get('http://34.204.94.231:3000/api/markAllAsRead', {
        headers: {
          'x-access-token': token,
        },
      });
...
export const getOpenBalanceGraphData = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      const token = localStorage.getItem('token'); // Assuming your user slice has a 'token' field
      const response = await axios.get('http://34.204.94.231:3000/api/openBalanceGraphYearly', {
        headers: {
          'x-access-token': token,
        },
      });
...
export const getSellBalanceGraphData = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      const token = localStorage.getItem('token'); // Assuming your user slice has a 'token' field
      const response = await axios.get('http://34.204.94.231:3000/api/sellBalanceGraphYearly', {
        headers: {
          'x-access-token': token,
        },
      });
...
export const getProfitBalanceGraphData = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      const token = localStorage.getItem('token'); // Assuming your user slice has a 'token' field
      const response = await axios.get('http://34.204.94.231:3000/api/profitGraphYearly', {
        headers: {
          'x-access-token': token,
        },
      });
...
export const getSettings = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    try {
      const token = localStorage.getItem('token'); // Assuming your user slice has a 'token' field
      const response = await axios.get('http://34.204.94.231:3000/api/getSetting', {
        headers: {
          'x-access-token': token,
        },
      });
...
export const createSettings = createAsyncThunk(
  ...
  async ({buy_amount_dollar, profit_percentage}, { dispatch }) => {
    try {
      ...
      // Make the API call to get wallet details
      const response = await axios.post(
        'http://34.204.94.231:3000/api/createSetting',
...
export const editSettings = createAsyncThunk(
  ...
  async ({ trade_setting_id, buy_amount_dollar, profit_percentage }, { dispatch }) => {
    try {
      ...
      // Make the API call to get wallet details
      const response = await axios.post(
        'http://34.204.94.231:3000/api/editSetting',
...
export const deleteSettings = createAsyncThunk(
  ...
  async ({trade_setting_id, user_id}, { dispatch }) => {
    try {
      ...
      // Make the API call to get wallet details
      const response = await axios.post(
        'http://34.204.94.231:3000/api/deleteSetting',
...
export const pauseSettings = createAsyncThunk(
  ...
  async (trade_setting_id, { dispatch }) => {
    try {
      ...
      // Make the API call to get wallet details
      const response = await axios.post(
        'http://34.204.94.231:3000/api/pauseTrading',
        { trade_setting_id },
        {
          headers: {
            'x-access-token': `${token}`,
...
export const startSettings = createAsyncThunk(
  ...
  async (trade_setting_id, { dispatch }) => {
    try {
      ...
      // Make the API call to get wallet details
      const response = await axios.post(
        'http://34.204.94.231:3000/api/startTrading',
        { trade_setting_id },
        {
          headers: {
            'x-access-token': `${token}`,
